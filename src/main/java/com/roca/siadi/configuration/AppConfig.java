 ...
 */
package com.roca.siadi.configuration;
...
import com.roca.siadi.interceptor.AccessInterceptor;
import com.roca.siadi.interceptor.InventarioInterceptor;

@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.roca")
